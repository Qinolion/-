...
#小市民シリーズ
urls='https://bangumi.tv/subject/474906/comments?page='
for i in tqdm(range(1,79)):
    ...
    for comment in comments:
        ...
        try:
            ...
            # 根据星级分类保存评论
            if star_number == 6:
                with open('S1.txt', 'a', encoding='utf-8') as file:
                    file.write(comment_text + '\n\n')
            elif star_number > 6:
                with open('S2.txt', 'a', encoding='utf-8') as file:
                    file.write(comment_text + '\n\n')
            elif star_number <6 and star_number >0:
                with open('S0.txt', 'a', encoding='utf-8') as file:
                    file.write(comment_text + '\n\n')
            else :
                with open('S_no.txt', 'a', encoding='utf-8') as file:
                    file.write(comment_text + '\n\n')
